...
C---------------------------------------------------------------------
     ...
     +1,1.5,2,3,4,5,7.5,10];'
      ...
      write(9999,*) 'figure(1)'
      write(9999,*) 'clf;'
      write(9999,*) ' bins = [5 15 25 35 45 55 65 75 85 95];'
      write(9999,*) 'hist(GOF(:,2:4), bins)'
     ...
     +,DFname,ii))'
      ...
      write(9999,*) ''      
      write(9999,*) '   legend(''Set 1'',''Set 2'',3)'
     ...
     +,DFname,ii))'
      ...
      write(9999,*) '0.5 0.75 1.0 1.5 2.0 3.0 4.0 5.0 7.5 10 0.0];'
      write(9999,*) ''
      write(9999,*) ''
